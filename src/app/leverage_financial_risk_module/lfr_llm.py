...
# def build_lfr_prompt(company, metrics, flags):
...
# LATEST METRICS:
# Debt/Equity: {latest['de_ratio']}
# Debt/EBITDA: {latest['debt_ebitda']}
# Net Debt/EBITDA: {latest['net_debt_ebitda']}
# Interest Coverage: {latest['interest_coverage']}
# ST Debt Ratio: {latest['st_debt_ratio']}
...
# def run_lfr_llm_agent(company, metrics, flags):
#     prompt = build_lfr_prompt(company, metrics, flags)
