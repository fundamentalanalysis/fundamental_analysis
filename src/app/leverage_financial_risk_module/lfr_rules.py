...
#                 "A1", "Debt to Equity", "de_ratio", "Latest",
#                 "RED", de, f">={benchmarks.de_ratio_critical}",
#                 "Critical leverage level."
#             ))
#         elif de >= benchmarks.de_ratio_high:
#             results.append(_make(
#                 "A1", "Debt to Equity", "de_ratio", "Latest",
#                 "YELLOW", de,
#                 f"{benchmarks.de_ratio_high}–{benchmarks.de_ratio_critical}",
#                 "High leverage."
#             ))
#         else:
#             results.append(_make(
#                 "A1", "Debt to Equity", "de_ratio", "Latest",
#                 "GREEN", de, f"<{benchmarks.de_ratio_high}",
#                 "Healthy leverage."
#             ))
...
#         results.append(_make(
#             "B1", "Interest Coverage", "interest_coverage", "Latest",
#             flag, icr,
...
#         results.append(_make(
#             "C1", "Short-Term Debt Dependence", "st_debt_ratio", "Latest",
#             flag, st_ratio,
#             f"{benchmarks.st_debt_ratio_warning}–{benchmarks.st_debt_ratio_critical}",
