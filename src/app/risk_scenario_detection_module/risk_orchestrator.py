...
class RiskOrchestrator:
    ...
    async def run(self, payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        #     )
        # }
        # Inside run() after defining all *_arr arrays

        financial_data = {
            "ebit": ebit_arr,
            "interest": interest_arr,
            "operating_cash_flow": ocf_arr,
            "net_debt": net_debt_arr,
            "net_income": net_income_arr,
            "cash": cash_arr,
            "oneoff_income": oneoff_arr,
            "receivables": total_recv_arr,
            "fixed_assets": fixed_assets_arr,
            "dividends": dividend_arr,
            "loan_rollover": rollover_arr,
            "interest_capitalized": int_cap_arr,
            "principal_repayment": principal_repayment_arr,
            "rpt_sales": rpt_sales_arr,
            "rpt_receivables": rpt_recv_arr,
            "total_revenue": total_sales_arr
        }

        trends = RiskTrendAnalyzer.build_trends_output(financial_data)
