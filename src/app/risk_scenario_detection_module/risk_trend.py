...
#                 "insight": (
#                     "EBIT has been insufficient to cover interest for multiple years, indicating zombie-like earnings."
#                     if len(ebit_below) >= 2
#                     else "EBIT comfortably covers interest obligations."
#                 ),
#             },
#         },
#         "cfo_vs_interest": {
...
#                     if len(cfo_below) >= 2
#                     else "Cash flows are generally sufficient to service interest."
#                 ),
#             },
#         },
#         "debt_vs_profit": {
...
#                 "insight": (
#                     "Debt increased while profits weakened, indicating a debt spiral."
#                     if len(debt_profit) >= 2
#                     else "Debt and profit trends remain broadly aligned."
#                 ),
#             },
#         },
#     }
...
#     # 3.2 WINDOW DRESSING
#     # =====================================================
#     cash_spike, profit_spike, recv_profit = [], [], []

#     for i in range(1, len(years)):
#         y, p = years[i], years[i - 1]

#         if metrics[p]["cash"] > 0 and (
#             (metrics[y]["cash"] - metrics[p]["cash"]) / metrics[p]["cash"] > 0.25
#         ):
#             cash_spike.append(y)

#         if metrics[p]["net_profit"] > 0 and (
#             (metrics[y]["net_profit"] - metrics[p]["net_profit"])
#             / metrics[p]["net_profit"]
#             > 0.25
#         ):
#             profit_spike.append(y)

#         if (
#             metrics[y]["receivables"] < metrics[p]["receivables"]
#             and metrics[y]["net_profit"] > metrics[p]["net_profit"]
#         ):
...
#                     if cash_spike
#                     else "No abnormal year-end cash spikes detected."
#                 ),
#             }
#         },
#         "profit_spike": {
...
#                 "insight": (
#                     "Sharp profit jumps may indicate cosmetic earnings management."
#                     if profit_spike
...
#             "insight": "Quarterly data not available; volatility analysis cannot be performed.",
#         },
...
#                 "insight": (
#                     "Profit increase with receivable decline suggests earnings beautification."
#                     if recv_profit
#                     else "Receivables and profit trends are consistent."
#                 ),
#             }
#         },
#     }
...
#                 "insight": (
#                     "Sustained decline in fixed assets indicates possible asset stripping."
#                     if len(asset_decline) >= 2
#                     else "No sustained fixed asset decline observed."
#                 ),
#             }
#         },
#         "debt_vs_assets": {
...
#                 "insight": (
#                     "Debt increased while assets shrank, indicating hollowing-out risk."
#                     if len(debt_asset) >= 2
#                     else "Debt and asset movements are aligned."
#                 ),
#             }
#         },
#         "dividends_vs_assets": {
#             "status": "NOT_APPLICABLE",
#             "insight": "Dividend payouts are negligible; asset stripping via dividends unlikely.",
#         },
#         "promoter_extraction": {
#             "status": "DATA_LIMITED",
#             "insight": "No direct promoter withdrawal data available beyond related-party indicators.",
#         },
#     }
...
#                 "insight": (
#                     "High loan rollover suggests reliance on refinancing."
#                     if rollover
...
#         "debt_vs_ebitda": {
#             "comparison": {
#                 "flagged_years": debt_ebitda,
#                 "rule_triggered": len(debt_ebitda) >= 2,
#                 "insight": (
#                     "Debt increased while EBITDA stagnated, indicating evergreening risk."
#                     if len(debt_ebitda) >= 2
#                     else "Debt growth is supported by EBITDA."
#                 ),
#             }
#         },
#         "principal_repayment": {
#             "status": "NOT_COMPUTABLE",
#             "insight": "Short-term principal repayment split is not disclosed.",
#         },
#         "interest_capitalization": {
#             "status": "NOT_COMPUTABLE",
#             "insight": "No data on interest capitalization into assets.",
#         },
#     }
...
#                 "insight": (
#                     "Revenue growth without cash support suggests fake revenue risk."
#                     if sales_cfo
...
#         "rpt_sales_spike": {
#             "status": "DATA_LIMITED",
#             "insight": "Insufficient data to confirm abnormal RPT sales spikes.",
#         },
#         "rpt_receivables_high": {
#             "status": "DATA_LIMITED",
#             "insight": "RPT receivables data insufficient for threshold-based analysis.",
#         },
#         "rpt_balance_rising": {
#             "status": "DATA_LIMITED",
#             "insight": "Long-term RPT balance trend not sufficiently disclosed.",
#         },
#     }
